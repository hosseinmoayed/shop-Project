...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('article_module', '0009_alter_article_date_alter_article_writer'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='article_module.articlecomment', verbose_name='پاسخ')),
